...
/* Example of including additional open source apps  */
        ...
        {CFE_SB_MSGID_WRAP_VALUE(COMMMC_CMD_MID), 101, 0, 8, {COMMMC_APP_COMMAND_TASK_ID_SEND_MINIMAL_TM_TO_GROUND}},
        {CFE_SB_MSGID_WRAP_VALUE(COMMMC_CMD_MID), 301, 0, 8, {COMMMC_APP_COMMAND_TASK_ID_SEND_MAX}},
#endif
#ifdef HAVE_HK
